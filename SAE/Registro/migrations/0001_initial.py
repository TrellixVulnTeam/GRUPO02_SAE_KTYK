# Generated by Django 2.2.5 on 2019-09-09 21:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            managers=[
                ('profesor', django.db.models.manager.Manager()),
            ],
        ),
        migrations.CreateModel(
            name='Curso',
            fields=[
                ...
                ('profesorjefe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Registro.Prosefor')),
            ],
            managers=[
